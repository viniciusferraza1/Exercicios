...
for (let i = 0; i < 11; i++)
{
  console.log(`Esta é a ${timeReceived}ª vez que esta frase é exibida no console.`)
    timeReceived++
}
...
const cities = ['São Paulo', 'Rio de Janeiro', 'Minas Gerais','Africa']
